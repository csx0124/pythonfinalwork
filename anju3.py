...
def draw2(title):#画柱状图
    ...
    plt.title(title+"学区房房价评估")
    name_list = ['500米以内有学校', '500米到1公里以内有学校', '1-2公里以内有学校', '2公里以上以内有学校']
    #number=[dis1,dis2,dis3,dis4]
    plt.xlabel("距离")
    plt.ylabel('数量')

    plt.xticks((0,1,2,3),('500米以内有学校', '500米到1公里以内有学校', '1-2公里以内有学校', '2公里以上以内有学校'))
...
def drawpie(name,count):#画饼状图
    pp=['小于500米', '500米到1公里', '1-2公里','2公里以上']
    plt.title("学区房"+name)
    labels=pp
    sizes=count
